...
namespace WindowsFormsApp1
{
    public partial class Add_User : Form
    {
        ...
        private void label4_Click(object sender, EventArgs e)
        {
            ...
            string sql = "GRANT INSERT, UPDATE, DELETE ON Students TO Abubakar";

            using (OracleConnection connection = new OracleConnection("Data Source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA =(SERVER = DEDICATED)(SERVICE_NAME = XE)));User Id=SUPER_PANEL;Password=1214"))
            {
